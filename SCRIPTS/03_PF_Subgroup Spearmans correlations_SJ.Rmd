...
```{r}
# IMPORTANT FUNCTIONS
sig.corr_matrices = function(corr_mat, threshold = 0.8){
...
corr_spearmans = sig.corr_matrices(cor(incr_grp,method="spearman"))
corr_pmat = cor_pmat(incr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: Gluc Inc") %>% ggplotly()

cor_scatter_plot(incr_grp, c("Testosterone", "IGFBP.1","Glucose","IGF.1","BMI"), title="Data: BLEF, Grp: Gluc Inc")

# Decreased group
corr_spearmans = sig.corr_matrices(cor(decr_grp,method="spearman"))
corr_pmat = cor_pmat(decr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: Gluc Dec") %>% ggplotly()

cor_scatter_plot(decr_grp, c("Leptin", "hsCRP", "Glucose", "IGFBP.1"), title="Data: BLEF, Grp: Gluc Dec")
...
corr_pmat = cor_pmat(incr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: Gluc_BLEF Inc") %>% ggplotly()


cor_scatter_plot(incr_grp, c("Cortisol", "IGFBP.1","Glucose",
                             "SHBG", "Non_HDL_Chol","Glucose.BLEF", "Testosterone"), 
...
corr_pmat = cor_pmat(decr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: Gluc_BLEF Dec") %>% ggplotly()


cor_scatter_plot(decr_grp, c("Glucose.BLEF", "hsCRP", "SHBG", "Trig_HDL_Ratio", 
...
corr_pmat = cor_pmat(incr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: Ins Inc") %>% ggplotly()

cor_scatter_plot(incr_grp, c("Beta.hydroxy.butyrate", "Leptin", 
...
corr_pmat = cor_pmat(decr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: Ins Dec") %>% ggplotly()

cor_scatter_plot(decr_grp, c("Insulin", "Glucose",
                             "Beta.hydroxy.butyrate", "FreeT3", "Cortisol"), 
                 title="Data: BLEF, Grp: Ins Inc")
...
corr_pmat = cor_pmat(incr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: Ins_BLEF Inc") %>% ggplotly()

cor_scatter_plot(incr_grp, c("Insulin.BLEF", "IGF.1,Cortisol",
...
corr_pmat = cor_pmat(decr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: Ins_BLEF Dec") %>% ggplotly()

cor_scatter_plot(decr_grp, c("Insulin.BLEF", "IGF.1", "Cortisol", "Testosterone", "Estradiol"), 
...
corr_pmat = cor_pmat(incr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: Tg Inc") %>% ggplotly()

# Decreased group
corr_spearmans = sig.corr_matrices(cor(decr_grp,method="spearman"))
corr_pmat = cor_pmat(decr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: Tg Dec") %>% ggplotly()
...
corr_pmat = cor_pmat(incr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: Tg_BLEF Inc") %>% ggplotly()

# Decreased group
corr_spearmans = sig.corr_matrices(cor(decr_grp,method="spearman"))
corr_pmat = cor_pmat(decr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: Tg_BLEF Dec") %>% ggplotly()
```
...
corr_pmat = cor_pmat(incr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: LDL Inc") %>% ggplotly()

# Decreased group
corr_spearmans = sig.corr_matrices(cor(decr_grp,method="spearman"))
corr_pmat = cor_pmat(decr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: LDL Dec") %>% ggplotly()
...
corr_pmat = cor_pmat(incr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: LDL_BLEF Inc") %>% ggplotly()

# Decreased group
corr_spearmans = sig.corr_matrices(cor(decr_grp,method="spearman"))
corr_pmat = cor_pmat(decr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: LDL_BLEF Dec") %>% ggplotly()
```
...
# Higher group
par(mfrow=c(2,1),pty="m")
corr_spearmans = sig.corr_matrices(cor(highr_grp,method="spearman"))
corr_pmat = cor_pmat(highr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: IGF.1 High") %>% ggplotly()

# Lower group
corr_spearmans = sig.corr_matrices(cor(lowr_grp,method="spearman"))
corr_pmat = cor_pmat(lowr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: IGF.1 Low") %>% ggplotly()
...
corr_pmat = cor_pmat(highr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: IGF.1_BLEF high") %>% ggplotly()

# lower group
corr_spearmans = sig.corr_matrices(cor(lowr_grp,method="spearman"))
corr_pmat = cor_pmat(lowr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: IGF.1_BLEF low") %>% ggplotly()
```
...
corr_pmat = cor_pmat(highr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: Cort high") %>% ggplotly()

# lower group
corr_spearmans = sig.corr_matrices(cor(lowr_grp,method="spearman"))
corr_pmat = cor_pmat(lowr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: Cort low") %>% ggplotly()
...
corr_pmat = cor_pmat(highr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: Cort_BLEF high") %>% ggplotly()

# lower group
corr_spearmans = sig.corr_matrices(cor(lowr_grp,method="spearman"))
corr_pmat = cor_pmat(lowr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: Cort_BLEF low") %>% ggplotly()
```
...
corr_pmat = cor_pmat(highr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: T3 high") %>% ggplotly()

# lower group
corr_spearmans = sig.corr_matrices(cor(lowr_grp,method="spearman"))
corr_pmat = cor_pmat(lowr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BLEF, Grp: T3 low") %>% ggplotly()
...
corr_pmat = cor_pmat(highr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: T3_BLEF high") %>% ggplotly()

# lower group
corr_spearmans = sig.corr_matrices(cor(lowr_grp,method="spearman"))
corr_pmat = cor_pmat(lowr_grp, method='spearman')
ggcorrplot(corr_spearmans, p.mat = corr_pmat, type="lower",
           insig = "blank", sig.level = 0.05, title="Data: BL, Grp: T3_BLEF low") %>% ggplotly()
```