...
```{r, message=FALSE}
# source("./Giovanni/Metabolomics functions_SJ_GF.R")
...
pca_dim1_list <- read.csv("Giovanni/PFS_significant_metabolites_PCA_Dim1_only_AM.csv",header=T,sep=",")
# Convert to a vector
...
# Save to csv
write.csv(df_corr_comb_unique, file="Giovanni/PFS_significant_metabolites_AM.csv",
          row.names = FALSE, na = "")
